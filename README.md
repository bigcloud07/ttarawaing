...
따릉이 이용권 시간을 초과할 것으로 예상되면 이동 경로 주변에서 중간에 반납하고 다시 대여할 수 있는 대여소도 자동으로 추천합니다.
...
따라와잉은 장소 검색, 대여소 추천, 도보·자전거 경로, 이용권 시간 관리를 한 화면에서 이어서 보여줍니다.
...
- 출발·대여·중간 경유·반납·도착 지점별 지도 포커스와 확대
- 최근 검색 경로 저장
- 모바일 지도 확대와 드래그 가능한 상세 경로 패널
